    ...
    static class Program
    {
        ...
        static void Main()
        {
            ...
            //{
                ...
                //Application.Run(new MainForm(lf.LoginInfo, lf.counterManage, new MotorClass(), new ImageIdentityClass()));

                LoginForm lf = new LoginForm();
                Application.Run(lf);
                if (lf.LoginInfo != "")
                {
                    Application.Run(new MainForm(lf.LoginInfo, lf.counterManage, new MotorClass(), new ImageIdentityClass()));//, new ImageLocateClass()
                }
            //}
            //else
            //{
            //    MessageBox.Show("请连接加密狗！", "警告", MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
    ...
    public class Vikey
    {
        ...
        public static int ViKeyTest()
        {
            ...
            for (j = 0; j < Count; j++)
            {
                ...
                passStrl = System.Text.Encoding.ASCII.GetString(buffer);
                System.Console.WriteLine("Read:" + passStrl);
                if (passStrl != str1)
                {
        ...
        //    if (ViKeyTest() == 0)
        //    {
        //        Console.WriteLine("加密狗获取成功！");
        //    }
        //    else
        //    {
        //        Console.WriteLine("请连接加密狗！");
        //    }
        //}
    }
}
